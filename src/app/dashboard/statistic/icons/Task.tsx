...
const Task = ({fill, background} : {fill: string, background: string}) => {
    return (
        <div style={{background: `${background}`}} className='w-11 h-11 rounded-xl flex items-center justify-center bg-opacity-30'>
        <svg style={{fill: `${fill}`}} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
