...
const SearchInput: React.FC<SearchBoxProps> = ({ placeholder = 'Search...', defaultValue = '', onSearch, className }) => {
  ...
  return (
    <div className={`flex gap-[8px] items-center border rounded-[8px] px-4 py-2 shadow-xs bg-white ${className}`}>
