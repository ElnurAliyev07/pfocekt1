import ContactWithUs from '@/app/(home)/components/ui/buttons/ContactWithUs'
import { WorkspaceContact } from '@/types/workspace.type'
...
const Contact: React.FC<Props> = ({data}) => {
  return (
    <section className='custom-container'>
      <div className='relative mt-[72px] md:mt-[144px] h-auto md:h-[500px] overflow-hidden rounded-[8px] md:rounded-[20px]'>
